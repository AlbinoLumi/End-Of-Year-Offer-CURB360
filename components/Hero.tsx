        ...
        >
            ...
            {isExpired ? (
              <>
                <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-6">
                    Thank You for Your <span className="text-brandRed">Participation!</span>
                </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button
                    ...
                    className="px-8 py-4 rounded-full text-lg font-bold bg-gray-500 text-gray-200 cursor-not-allowed opacity-60"
                >
                    Offer Ended
                </button>
                <a 
            ...
            <p className="mt-6 text-sm text-gray-400">
                {isExpired 
                  ? 'This offer has ended. Thank you for your participation!' 
